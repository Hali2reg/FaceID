...
/*********************************************/
#define NANDFLASH_DATA  *( volatile Uint8* )( 0x02000000 + 0x00 )
#define NANDFLASH_CLE   *( volatile Uint8* )( 0x02000000 + 0x10 )
#define NANDFLASH_ALE   *( volatile Uint8* )( 0x02000000 + 0x08 )
