...
#define ISIF_REC6561F             *( volatile Uint32* )( ISIF_BASE + 0x84 )
 ...
 *  Function Renaming                                                       *
 * ------------------------------------------------------------------------ */
#define EVMDM368_wait          _wait
#define EVMDM368_waitusec      _waitusec
...
Int16 EVMDM368_init( );
Uint16 EVMDM368_CPLD_rget(Int16 regnum);
void EVMDM368_CPLD_rset(Int16 regnum, Uint8 regval);
